"""
Project GOAT v0.7 — Evidence Synthesis Context

Defines the immutable EvidenceSynthesisContext model carrying active artifact IDs across evidence synthesis operations.
"""
...
class EvidenceSynthesisContext(BaseModel):
    """Immutable context carrying active artifact references for scientific evidence synthesis."""
