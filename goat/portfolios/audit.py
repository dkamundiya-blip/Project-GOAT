"""
Project GOAT v0.7 — Portfolio Audit Engine

Defines the immutable PortfolioAuditEvent model representing append-only audit trail logs for scientific research portfolios.
"""
...
class PortfolioAuditEvent(BaseModel):
    """Immutable audit trail event logged during portfolio governance transitions."""
    ...
    event_type: str = Field(..., description="Event type ('CREATE', 'GOVERNANCE', 'SCHEDULE', 'EXECUTE', 'PAUSE', 'RESUME', 'COMPLETE', 'REPLAY', 'ARCHIVE')")
